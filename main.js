...
function drawChart() {
  ...
  dataTable.addRows([
    ...
    ['Ģimenes transporta līdzeklis', 'Toyota Verso (gaida Latvijā)', new Date(2019, 11, 3), new Date(today)],
    ['Ģimenes transporta līdzeklis', 'Thule Chariot Lite 2 (Japānā)', new Date(2021, 0, 7), new Date(today)],
    ...
    ['Skriešanas apavi', 'Asics Gel-Nimbus 21 SP (Gaida Latvijā)', new Date(2019, 3, 24), new Date(today)],
    ...
    ['Soma', 'Peak Design - Everyday Messenger', new Date(2022, 1, 1), new new Date(today)],
