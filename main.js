...
function drawChart() {
  ...
  dataTable.addRows([
    ...
    ['Dzīvesvieta', 'Latvija, Sigulda', new Date(2019, 11, 2), new Date(today)],
    ...
    ['Monitors', 'LG 27" 27UL550 4K HDR', new Date(2019, 11, 16), new Date(today)],
    ...
    ['Pulkstenis', 'Pulksteni nelietoju', new Date(2002, 5, 27), new Date(2015, 2, 4)],
    ['Pulkstenis', 'Apple Watch (series 0) tagad lieto sieva', new Date(2015, 2, 4), new Date(today)],
    ...
    ['Spēļu konsole', 'Xbox 360', new Date(2014, 10, 25), new Date(2016, 6, 11)],
    ['Spēļu konsole', 'Xbox 360 atstāju tētim lietošanā', new Date(2016, 6, 11), new Date(today)],
