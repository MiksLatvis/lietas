...
function drawChart() {
  ...
  dataTable.addRows([
    ...
    ['Ģimenes transporta līdzeklis', 'Thule Chariot Lite 2', new Date(2021, 0, 7), new Date(today)],
    ...
    ['Spēļu konsole', 'Xbox Series S', new Date(2021, 9, 5), new Date(today)],
    ...
    ['Kafijas aparāts', 'Breville The Grind Control (Japānā, lietots) 90EUR', new Date(2021, 10, 11), new Date(today)],
