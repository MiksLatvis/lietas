...
function drawChart() {
  ...
  dataTable.addRows([
    ...
    ['Ģimenes transporta līdzeklis', 'Thule Chariot Lite 2 (Japānā)', new Date(2021, 0, 7), new Date(2023, 3, 16)],
    ...
    ['Dators', 'MacBook Air 13" 2016 (skolas dators lietots) 157 EUR', new Date(2021, 1, 18), new Date(today)],
    ...
    ['Pele un klaviatūra', 'Apple Magic Trackpad (ar baterijām)', new Date(2016, 11, 04), new Date(today)],
    ['Pele un klaviatūra', 'Apple Magic Mouse 2', new Date(2016, 11, 04), new Date(today)],
    ['Pele un klaviatūra', 'Apple Magic Keyboard ar baterijām (Latvijā)', new Date(2012, 06, 06), new Date(today)],
    ['Pele un klaviatūra', 'Apple Magic Keyboard (Japānā)', new Date(2020, 11, 24), new Date(today)],
    ...
    ['Telefons', 'iPhone 11 Pro', new Date(2019, 11, 23), new Date(2020, 11, 23)],
    ...
    ['Mājas audio', 'HomePod mini', new Date(2021, 1, 21), new Date(today)],
    ...
    ['Skriešanas apavi', 'Asics Gel-Nimbus 21 (Japānā)', new Date(2021, 0, 5), new Date(today)],
    ['Spēļu konsole', 'Xbox 360', new Date(2014, 10, 25), new Date(today)],
    ['Spēļu konsole', 'Xbox One (Japānā)', new Date(2016, 9, 11), new Date(today)],
    ['Spēļu konsole', 'Xbox One S All-digital (Latvijā)', new Date(2019, 11, 11), new Date(today)],
    ['Spēļu konsole', 'Xbox Series S (Japānā)', new Date(2021, 9, 5), new Date(today)],
    ['Virtuve', 'Zorijushi rīsu aparāts', new Date(2021, 0, 25), new Date(today)],
    ...
    ['Kafijas aparāts', 'Sage the Barista Express (Latvijā)', new Date(2020, 4, 15), new Date(today)],
    ['Kafijas aparāts', 'Nespresso Essenza Plus', new Date(2021, 1, 4), new Date(2023, 5, 21)],
    ['Kafijas aparāts', 'Breville The Grind Control (Japānā, pirkts lietots) 90EUR', new Date(2021, 10, 11), new Date(2023, 5, 21)],
    ['Soma', 'Crumpler - The Super Boomer L (messenger bag)', new Date(2007, 8, 18), new Date(today)],
